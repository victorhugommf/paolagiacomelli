...
$attachment_image_src = wp_get_attachment_url(get_the_ID());
$attachment_image_alt = get_post_meta( get_the_ID(), '_wp_attachment_image_alt', true );
            ...
            <div class="content-container span<?php echo (int)esc_attr($column); ?>">
                <section id='main_content'>
                    <?php if (isset($attachment_image_src[1]) && $attachment_image_src[1] > 0) { ?>
                        <img src="<?php echo esc_url($attachment_image_src[0]); ?>" alt="<?php echo esc_attr($attachment_image_alt); ?>"/>
                    <?php } ?>
                </section>
            </div>
            <?php
