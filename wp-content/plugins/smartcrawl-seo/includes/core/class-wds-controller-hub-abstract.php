...
abstract class Smartcrawl_Controller_Hub_Abstract {
	...
	public function json_seo_summary() {
		...
		$autolinks_settings = Smartcrawl_Autolinks_Settings::get();
		...
		$schema_active         = ! smartcrawl_get_array_value( $options, 'disable-schema' ) && Smartcrawl_Settings_Admin::is_tab_allowed( Smartcrawl_Settings::TAB_SCHEMA );
	...
	private function is_active( $module ) {
		return Smartcrawl_Settings::get_setting( $module ) && Smartcrawl_Settings_Admin::is_tab_allowed( 'wds_' . $module );
	}
