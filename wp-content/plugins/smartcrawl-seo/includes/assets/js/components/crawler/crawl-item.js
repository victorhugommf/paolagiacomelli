		...
		return <tr>
			...
			<td>
				...
				<Dropdown loading={this.props.loading}
						  ...
						  buttons={[
							  <DropdownButton className="wds-list-occurrences"
											  text={__('List Occurrences', 'wds')}
											  icon="sui-icon-list-bullet"
											  onClick={() => this.startShowingOccurrences()}
							  />,
							  <DropdownButton className="wds-redirect-crawl-item"
											  text={__('Redirect', 'wds')}
											  icon="sui-icon-arrow-right"
											  onClick={() => this.props.onRedirect()}
							  />,
							  <DropdownButton className="wds-ignore-crawl-item"
											  text={__('Ignore', 'wds')}
