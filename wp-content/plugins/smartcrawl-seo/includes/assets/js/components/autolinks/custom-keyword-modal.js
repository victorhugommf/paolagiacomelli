...
const KeywordField = fieldWithValidation(TextInputField, [isNonEmpty, isValuePlainText]);
const UrlField = fieldWithValidation(TextInputField, [isNonEmpty, isValuePlainText]);
