					...
					<?php if ( ! $hide_branding ): ?>
						<td class="hero-image"
							...
							<img src="<?php echo esc_url( $header_image_url_2x ); ?>"
							     ...
							     style="-ms-interpolation-mode: bicubic; border: none; vertical-align:bottom; clear: both; display: inline-block; outline: none; text-decoration: none; width: 141px; height: auto" width="141">
						</td>
					<?php endif; ?>
				</tr>
				</tbody>
