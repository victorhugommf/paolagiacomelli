				...
				<tr style="padding: 0; text-align: left; vertical-align: top;">
					<td class="main-content-text"
						...
						<p style="color: #333333;font-family: 'Roboto', Arial, sans-serif;font-size: 25px;font-weight: 700;line-height: 34px;margin: 0 0 5px;padding: 0;text-align: left;">
							...
							__( 'SEO test summary for <br/>%s', 'wds' ),
						...
						<p style="margin: 0 0 30px;padding: 0;text-align: center">
							<a style="color: #286EFA;font-family: 'Roboto', Arial, sans-serif;font-size: 12px;font-weight: 500;letter-spacing: -0.25px;line-height: 16px;text-decoration: none"
