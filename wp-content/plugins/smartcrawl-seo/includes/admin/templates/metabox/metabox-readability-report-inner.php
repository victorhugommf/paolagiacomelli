			...
			<div class="sui-accordion-item-body">
				<div class="sui-box">
					<div class="sui-box-body">
						...
						<p>
							<small><?php esc_html_e( 'The Flesch-Kincaid readability tests are readability tests designed to indicate how difficult a passage is to understand. Here are the benchmarks.', 'wds' ); ?></small>
						</p>
