...
$wf_admin_img_path = WF_PKLIST_PLUGIN_URL . 'admin/images/other_solutions';
...
$plugins=array(
    ...
    'pdf_invoices_plugin' => array(
        'title'         => __('WooCommerce PDF Invoices, Packing Slips, Delivery Notes and Shipping Labels', 'print-invoices-packing-slip-labels-for-woocommerce'),
        'description'   => __('Generate, customize, and manage WooCommerce documents including PDF invoices, packing slips, delivery notes, shipping labels, address labels, and other shipping documents using a single plugin.', 'print-invoices-packing-slip-labels-for-woocommerce'),
            ...
            <div class="wt_widget">
                ...
                <div class="wt_buttons">
                    <div class="wt_premium_button" style="width: 100%;">
                        <a href="<?php echo esc_url($value['premium_url']); ?>" class="wt_get_premium_btn" target="_blank"><img src="<?php echo esc_url($wf_admin_img_path . '/promote_crown.png');?>" style="width: 10px;height: 10px;"><?php  _e(' Get Premium','print-invoices-packing-slip-labels-for-woocommerce'); ?></a>
                    </div> 
<?php
