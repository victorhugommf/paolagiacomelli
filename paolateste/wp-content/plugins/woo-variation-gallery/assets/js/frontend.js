...
var WooVariationGallery = function ($) {
  ...
  var WooVariationGallery = /*#__PURE__*/function () {
    function WooVariationGallery(element, config) {
      ...
      this._config = $.extend({}, Default, config); //this.$product             = this._element.closest('.product');
    ...
    _createClass(WooVariationGallery, [{
      ...
      key: "dimension",
      value: function dimension() {//this._element.css('min-height', '0px');
      ...
      value: function enableThumbnailPosition() {
        ...
        if (woo_variation_gallery_options.is_vertical) {
          ...
          if (window.matchMedia("(max-width: 768px)").matches || window.matchMedia("(max-width: 480px)").matches) {
            ...
            this._element.removeClass("".concat(woo_variation_gallery_options.thumbnail_position_class_prefix, "left ").concat(woo_variation_gallery_options.thumbnail_position_class_prefix, "right ").concat(woo_variation_gallery_options.thumbnail_position_class_prefix, "bottom"));

            this._element.addClass("".concat(woo_variation_gallery_options.thumbnail_position_class_prefix, "bottom"));
            ...
            this._element.addClass("".concat(woo_variation_gallery_options.thumbnail_position_class_prefix).concat(woo_variation_gallery_options.thumbnail_position));
