...
<div id="reviews" class="woocommerce-Reviews cr-reviews-ajax-reviews">
	<div id="comments" class="cr-reviews-ajax-comments">
		...
		if ( have_comments() ) : ?>
			...
			?>
			<button class="cr-show-more-reviews-prd" type="button" data-nonce="<?php echo $nonce; ?>" data-page="1"<?php if ($cr_get_reviews['reviews_count'] < CR_Ajax_Reviews::get_per_page()) echo ' style="display:none"'; ?>><?php echo __( 'Show more', 'customer-reviews-woocommerce' ); ?></button>
