...
if ( ! class_exists( 'GT3_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The GT3 WooCommerce Adjacent Products Class
	 */
	class GT3_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'gt3_woocommerce_adjacent_query_args', $args ) );
