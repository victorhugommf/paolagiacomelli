        ...
        function add_importer_section() {
            ...
            if (version_compare($php_version, '5.4' , '<')) {
                $this->parent->sections[] = array(
                    ...
                    'desc'   => '<p><strong style="font-weight:700;">'.(__( "Disclaimer:", "framework" )).'</strong></p><p style="font-weight:700; color:red;">'. apply_filters( 'wbc_importer_description', __( 'The Demo Importer requires PHP 5.4 or higher. Please contact your hosting provider to update PHP.', 'framework' ) ).'</p></br>',
