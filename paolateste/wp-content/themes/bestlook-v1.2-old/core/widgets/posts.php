...
class posts extends WP_Widget
{
    ...
    {
        $defaultValues = array(
            'widget_title' => esc_html__( 'Recent Posts', 'wizestore' ),
        ...
        <table class="fullwidth">
            <tr>
                <td><?php echo esc_html__( 'Title:', 'wizestore' ); ?></td>
            ...
            <tr>
                <td><?php echo esc_html__( 'Number:', 'wizestore' ); ?></td>
            ...
            <tr>
                <td><?php echo esc_html__( 'Show post content:', 'wizestore' ); ?></td>
