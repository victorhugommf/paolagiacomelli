<?php
    ...
    // HEADER
            ...
            $options = array(
                ...
                array(
                    ...
                    'type'     => 'switch',
                    'title'    => esc_html__( 'Limit Logo on Mobile', 'wizeedu' ),
                    'default'  => true,
                ),
                array(
                    'id'     => 'logo-end', 
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array(
                'id'        => 'share_social',
                'type'      => 'switch',
                'title'     => esc_html__( 'Show Social links', 'yesstore' ),
                'default'   => false,
            ),
            array(
                ...
                'type'      => 'select',
                'multi'     => true,
                'title'     => esc_html__('Select Social links', 'yesstore' ),
                'options'   => array(
                    'facebook'      => esc_html__( 'Facebook', 'yesstore' ),
                    'twitter'       => esc_html__( 'Twitter', 'yesstore' ),
                    'pinterest'     => esc_html__( 'Pinterest', 'yesstore' ),
                    'google'        => esc_html__( 'Google plus', 'yesstore' ),
                    'tumblr'        => esc_html__( 'Tumblr', 'yesstore' ),
                    'mail'          => esc_html__( 'Mail', 'yesstore' ),
                    'reddit'        => esc_html__( 'Reddit', 'yesstore' ),
                    //'linkedin'      => esc_html__( 'LinkedIn', 'yesstore' ),
                    //'vk'            => esc_html__( 'VK', 'yesstore' ),
                ),
            ...
            array(
                ...
                'type'      => 'text',
                'title'     => esc_html__('Title for Facebook icon', 'yesstore' ),
                'default'   => '',
            ...
            array(
                ...
                'type'      => 'text',
                'title'     => esc_html__('Title for Twitter icon', 'yesstore' ),
                'default'   => '',
            ...
            array(
                ...
                'type'      => 'text',
                'title'     => esc_html__('Title for Pinterest icon', 'yesstore' ),
                'default'   => '',
            ...
            array(
                ...
                'type'      => 'text',
                'title'     => esc_html__('Title for Google plus icon', 'yesstore' ),
                'default'   => '',
            ...
            array(
                ...
                'type'      => 'text',
                'title'     => esc_html__('Title for LinkedIn icon', 'yesstore' ),
                'default'   => '',
            ...
            array(
                'id'        => 'share_social-vk',
                'type'      => 'text',
                'title'     => esc_html__('Title for VK icon', 'yesstore' ),
                'default'   => '',
            ...
            array(
                ...
                'type'      => 'text',
                'title'     => esc_html__('Title for Tumblr icon', 'yesstore' ),
                'default'   => '',
            ...
            array(
                ...
                'type'      => 'text',
                'title'     => esc_html__('Title for E-mail icon', 'yesstore' ),
                'default'   => '',
                'required'  => array( 'share_social_select', '=', 'mail' ),
                'subtitle'  => esc_html__( 'Send this article via e-mail to a friend', 'yesstore' ),
            ),
            array(
                'id'        => 'share_social-reddit',
                'type'      => 'text',
                'title'     => esc_html__('Title for Reddit icon', 'yesstore' ),
                'default'   => '',
    ...
    Redux::setSection( $opt_name, array(
        ...
        /*'desc'   => __( 'This is GT3 Registration', 'wizecore' ),*/
        'icon'   => 'el el-unlock',
