...
function gt3_custom_styles() {
    ...
    *{
	...
	body div[id*="ajaxsearchlitesettings"].searchsettings .asl_option_label,
	...
	.berocket_aapf_widget li input[type="checkbox"] + label.berocket_checked:before,
	.berocket_aapf_widget li input[type="radio"] + label.berocket_checked:before{
		-webkit-box-shadow: inset 0 0 0 1px #e4e5de, inset 0 0 0 5px #fff, inset 0 0 0 8px '.$theme_color2.';
		box-shadow: inset 0 0 0 1px #e4e5de, inset 0 0 0 5px #fff, inset 0 0 0 8px '.$theme_color2.';
	}
	...
	.berocket_aapf_widget li:hover input[type="radio"] + label:before{
		-webkit-box-shadow: inset 0 0 0 1px '.$theme_color2.', inset 0 0 0 8px #fff, inset 0 0 0 8px '.$theme_color2.';
		box-shadow: inset 0 0 0 1px '.$theme_color2.', inset 0 0 0 8px #fff, inset 0 0 0 8px '.$theme_color2.';
	}
    body div[id*="ajaxsearchlitesettings"].searchsettings .asl_option_inner input[type=checkbox]:checked:hover + label:after,
	...
	.berocket_aapf_widget li:hover input[type="checkbox"] + label.berocket_checked:before,
	.berocket_aapf_widget li:hover input[type="radio"] + label.berocket_checked:before{
		-webkit-box-shadow: inset 0 0 0 1px #a00, inset 0 0 0 8px #fff, inset 0 0 0 8px '.$theme_color2.';
		box-shadow: inset 0 0 0 1px #a00, inset 0 0 0 8px #fff, inset 0 0 0 8px '.$theme_color2.';
	}
	...
	if (is_array($label_color_hot) && isset($label_color_hot['rgba'])) {
		$custom_css .= '
		.woocommerce ul.products li.product span.onsale.hot-product,
		#yith-quick-view-content span.onsale.hot-product,
	...
	if (is_array($label_color_new) && isset($label_color_new['rgba'])) {
		$custom_css .= '
		.woocommerce ul.products li.product span.onsale.new-product,
		#yith-quick-view-content span.onsale.new-product,
		.woocommerce span.onsale.new-product{
			background-color: '.esc_attr($label_color_new['rgba']).';
		}';
	}
	/* label color option end */
