    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array(
                ...
                'type'     => 'switch',
                'title'    => esc_html__( 'Display out of stock products', 'wizestore' ),
                'default'  => false,
            ),
            array(
                'id'       => 'woocommerce_search',
                'type'     => 'switch',
                'title'    => esc_html__( 'Enable WooCommerce Search Instead of Default Search', 'wizestore' ),
                'default'  => false,
            ),
            ...
            array(
                ...
                'type'      => 'section',
                'title'     => esc_html__('"Sale", "Hot" and "New" labels color', 'wizestore'),
                'indent'    => true,
            ),
            array(
                'id'        => 'label_color_sale',
                'type'      => 'color_rgba',
                'title'     => esc_html__( 'Color for "Sale" label', 'wizestore' ),
                'subtitle'  => esc_html__( 'Select the Background Color for "Sale" label.', 'wizestore' ),
                'default'   => array(
                    'color'     => '#b1ba85',
                    'alpha'     => '1',
                    'rgba'      => 'rgba(177,186,133,1)'
                ),
            ),
            array(
                'id'        => 'label_color_hot',
                'type'      => 'color_rgba',
                'title'     => esc_html__( 'Color for "Hot" label', 'wizestore' ),
                'subtitle'  => esc_html__( 'Select the Background Color for "Hot" label.', 'wizestore' ),
                'default'   => array(
                    'color'     => '#e5625e',
                    'alpha'     => '1',
                    'rgba'      => 'rgba(229,98,94,1)'
                ),
            ),
            array(
                'id'        => 'label_color_new',
                'type'      => 'color_rgba',
                'title'     => esc_html__( 'Color for "New" label', 'wizestore' ),
                'subtitle'  => esc_html__( 'Select the Background Color for "New" label.', 'wizestore' ),
                'default'   => array(
                    'color'     => '#c2a5c8',
                    'alpha'     => '1',
                    'rgba'      => 'rgba(194,165,200,1)'
                ),
            ),
            array(
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array(
                ...
                'type'      => 'switch',
                'title'     => esc_html__( 'Activate Carousel for Vertical Thumbnail', 'wizestore' ),
                'subtitle'  => esc_html__( 'Carousel will be visible if Product has 4 and more thumbnails', 'wizestore' ),
                'default'   => false,
            ),
        )
    ) );
