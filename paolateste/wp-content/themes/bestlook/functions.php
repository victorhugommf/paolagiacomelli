                        ...
                        if (!is_user_logged_in()) {
                            ...
                            if (($is_nextend_facebook || $is_nextend_google) && get_option('woocommerce_enable_myaccount_registration')=='yes') {
                                ...
                                if ($is_nextend_twitter) {
                                    echo "<div class='gt3_module_button button_alignment_inline'>";
                                        echo "<a href='" . wp_login_url() . "?loginTwitter=1&redirect=" . get_permalink() . "' onclick='window.location = \"".wp_login_url()."?loginTwitter=1&redirect=\"+window.location.href; return false;' class='button_size_normal gt3_twitter_login' title='".esc_html__( 'Login with Twitter', 'wizestore' )."'>";
                                        echo '<i class="fa fa-twitter" aria-hidden="true"></i>';
                                        echo '<span>'.esc_html__( 'Login with Twitter', 'wizestore' ).'</span>';
                                        echo "</a>";
                                    echo "</div>";
                                }    
                                echo "</div>";                          
