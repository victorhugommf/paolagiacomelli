<?php
	...
	if( isset($attach_image) && !empty($attach_image) ) {
		...
		//$marker_circle_1 .= !empty($marker_outer_width) ? 'width: '.(int)$marker_outer_width.'px; height: '.(int)$marker_outer_width.'px;' : '';
...
/*				$marker_wrapper_start = '<div class="gt3_marker_wrapper" style="'.esc_attr($marker_pos).'">';
				$marker_wrapper_start .= '<div class="gt3_marker '.esc_attr($animation_class).'" style="'.esc_attr($animation_style).esc_attr($marker_pos).'">';
